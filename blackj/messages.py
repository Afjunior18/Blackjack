...
def rules_blackjack():
    ...
    print("Player's Turn:")
    print("---------------------------------------------------------------------------------")
    print("Player is required to HIT until reaching 15pts, then can choose to STAND or HIT.\n")
    print("Dealer's Turn:")
    print("---------------------------------------------------------------------------------")
    print("Dealer will always HIT until reaching 17 points or higher.\n")
    print("Scoring: (2 - 10: Face value), (Jack, Quen, King: 10 points) and (Ace: 11 points)")